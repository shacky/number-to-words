...
class SwahiliTripletTransformer implements PowerAwareTripletTransformer
{
    ...
    private SwahiliDictionary $dictionary;
    ...
    private function formatBelowHundred(int $number, bool $prependConjunction): string
    {
        ...
        if ($number < 10) {
            ...
            $words[] = ($units === 0)
                ? $this->dictionary->getCorrespondingTen(1)
                : $this->dictionary->getCorrespondingTeen($units);
        } else {
