...
class FrenchCurrencyTransformerTest extends CurrencyTransformerTest
{
    ...
    public function providerItConvertsMoneyAmountToWords(): array
    {
        return [
            [100, 'EUR', 'un euro'],
            [100, 'JPY', 'cent yens'],
            [101, 'JPY', 'cent un yens'],
            [115, 'JPY', 'cent quinze yens'],
            [200, 'EUR', 'deux euros'],
            ...
            [123456789, 'XPF', 'cent vingt-trois millions quatre cent cinquante-six mille sept cent quatre-vingt-neuf francs CFP'],
